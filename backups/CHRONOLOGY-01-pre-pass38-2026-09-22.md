# Chronology — Working Evidence Table

Project: **Curtea de Argeș — Arhiva Vie**  
Creator and curator: **Cican George Alin**  
Research date: **21 September 2026**

This is an evidence table, not yet the final narrative chronology. Dates remain at the precision supported by the cited source.

| Period / date | Event or evidence | Status | Source trail | Research note |
|---|---|---|---|---|
| Neolithic | Museum records include Neolithic archaeological material from the Curtea de Argeș area/collections. | SUPPORTED | S06 | The exact find locations and archaeological contexts must be researched before assigning a settlement history to the city itself. |
| Dacian / Roman / Byzantine periods | Museum collections include material identified with Dacian, Roman and Byzantine periods. | SUPPORTED | S06 | Collection presence is evidence for material history, but individual objects need provenance and excavation context before being used to reconstruct continuous settlement. |
...
| 1897 | The former hospital complex is listed in the LMI inventory with dating 1897. | VERIFIED | S07 | The relationship between the former hospital and the present municipal museum should be documented through institutional records. |
| 20th century | The museum and municipal sources document extensive collections and institutional development during the 20th century. | SUPPORTED | S06 | A separate institutional history should be researched from archival and museum sources. |
| 1916–1918 | National Institute of Heritage identifies a memorial cultural route in Curtea de Argeș containing sites connected to the First World War memory of the city. | VERIFIED | S10 | Build a dedicated WWI memorial inventory with individual monument records. |
| 20th–21st centuries | The historic urban site remains a protected heritage area, while individual buildings have changed use, been restored, altered or disappeared. | SUPPORTED | S01, S05, S07 | Needs a building-by-building change history. |

## Chronology gaps requiring research

- Earliest securely located archaeological evidence within the modern municipal territory.
- Prehistoric settlement sites and exact provenance of museum objects.
- Ancient-period settlement patterns and road/river relationships.
- Early medieval evidence before the documented princely centre.
- Documentary attestations and the exact evolution of the medieval political centre.
- The chronology and spatial development of the two medieval court complexes.
- The chronology of churches, cemeteries and religious communities.
- The development of streets, markets, crafts and trade.
- Administrative changes and municipal institutions.
- Education, health, printing, associations and everyday urban life.
- Railway construction, operation and social/economic effects.
...
\n\n## Chronology control update — Pass 16\n\nThe Sân Nicoară campaign report adds a spatial-historical layer to the chronology: the 2011 research explicitly investigated the site's relationship with the Domnească area and the city, alongside questions of construction sequence, stratigraphy and possible fortification. This should be represented later as a connected place/period record rather than as a single construction date. citeturn1search0turn2search4\n\nFor Olari, the archaeological intervention provides evidence for an earlier construction beneath/associated with the later church, including 15th–16th-century material, while the exact historical interpretation and the reported RAN 13631.09 identifier remain separate fields. citeturn2search0turn1search1\n\nThe chronology therefore continues to distinguish **archaeological evidence → register chronology → documentary evidence → interpretation**.